========================================================================
    ACTIVE TEMPLATE LIBRARY : PropBeeIE Project Overview
========================================================================

AppWizard has created this PropBeeIE project for you to use as the starting point for
...
PropBeeIE.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (PropBeeIE.h)
        GUID definitions                                (PropBeeIE_i.c)
        A type library                                  (PropBeeIE.tlb)
        Marshaling code                                 (PropBeeIE_p.c and dlldata.c)

PropBeeIE.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in PropBeeIE.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named PropBeeIE.pch and a precompiled types file named StdAfx.obj.
...
PropBeeIEps.vcproj
	...
	dlldata.c, PropBeeIE_i.c and PropBeeIE_p.c which are required
